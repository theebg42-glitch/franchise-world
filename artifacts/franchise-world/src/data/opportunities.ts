...
export const opportunities: Opportunity[] = [
  ...
  // ── RETAIL ───────────────────────────────────────────────────────────────
  {
    ...
    investment: "₹25L – ₹1 Cr+",
    description: "Represent a globally trusted brand with a presence in 160+ countries and a diversified electronics portfolio. Multiple investment formats, rapid India expansion, and strong investor demand create high earning potential for growth partners.",
    businessModel: "District Program / Business Partner",
    about: "Daewoo is a globally trusted electronics and appliance brand powered by POSCO International, with a presence in 160+ countries and a strong legacy of innovation and consumer trust. Offering a diverse portfolio of home appliances, consumer electronics, and smart lifestyle solutions, Daewoo is rapidly expanding across India through retail, distribution, and franchise-led growth opportunities.",
